...
export default function CarDetails() {
  return (
    <div className='car-details container mx-auto  my-12 relative '>
      <a href=""><Image src={ToBack} alt='' className='absolute -top-[0] left-[10px]'/></a>
      <div className="top mb-8 px-5">
        <h2 className=' font-medium text-[24px] lg:text-[28px] pl-[45px] mb-10'>Rent Rolls Royce Cullinan Mansory 2023 in Dubai</h2>
      ...
      <div className="center mb-20 px-5 flex gap-10 flex-col lg:flex-row">
        <div className="description flex-grow">
          <h2 className='font-medium text-[24px] leading-7 mb-6'>Description</h2>
          <p className='text-[#666666] '>Rent and drive this Rolls Royce Cullinan Mansory 2022-model in Dubai, UAE for AED 7500/day. Rental cost includes basic comprehensive insurance and standard mileage limit of 250 km/day (AED 15 per additional km applicable). Security deposit of AED 5000 is required. Contact Luxury Supercar Rentals directly for bookings and inquiries...</p>
          ...
          <div className="highlights">
            <h2 className='font-medium text-[24px] leading-7 mb-4'>Highlights</h2>
            <ul className='flex flex-wrap gap-x-10 gap-y-4'>
              <li className='flex gap-4 lg:w-[40%]'><Image src={RedCheck} alt=''/><span className='text-[18px] lg:text-[20px] font-medium leading-6'>1 Day Rental Available</span></li>
              <li className='flex gap-4 lg:w-[40%]'><Image src={RedCheck} alt=''/><span className='text-[18px] lg:text-[20px] font-medium leading-6'>Driver included</span></li>
              <li className='flex gap-4 lg:w-[40%]'><Image src={RedCheck} alt=''/><span className='text-[18px] lg:text-[20px] font-medium leading-6'>Deposit: AED300</span></li>
              <li className='flex gap-4 lg:w-[40%]'><Image src={RedCheck} alt=''/><span className='text-[18px] lg:text-[20px] font-medium leading-6'>Delivery Know More</span></li>
              <li className='flex gap-4 lg:w-[40%]'><Image src={RedCheck} alt=''/><span className='text-[18px] lg:text-[20px] font-medium leading-6'>Insurance Included</span></li>
              <li className='flex gap-4 lg:w-[40%]'><Image src={RedCheck} alt=''/><span className='text-[18px] lg:text-[20px] font-medium leading-6'>Insurance Included</span></li>
            </ul>
          </div>
        </div>
        <div className="check lg:min-w-[450px] bg-[#FAF9F9] shadow-xl rounded-lg px-6 py-10  self-start">
          ...
          <ul className=' flex flex-col gap-2'>
            ...
            <li className='text-[18px] lg:text-[20px] font-medium text-[#666666]'><span>3.</span> 500 km max</li>
          </ul>
