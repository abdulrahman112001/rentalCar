...
export default function Contact() {
  return (
    <div className="contact container mx-auto my-16 px-10">
      ...
      <p className="leading-5 lg:text-[20px] lg:w-[400px] my-6 text-center  mx-auto text-[#666666]">
        Book your car through our website without wasting your time
      </p>
      <div className="big-box flex flex-wrap justify-between items-center gap-y-10 my-14">
        <ContactBox
          ...
          title="WhatsApp"
          firstNumber="01023876299"
          secondNumber="01023876299"
          linkDescription="Chat With us"
        />
        <ContactBox
          link="/"
          contactImage={Phone}
