...
export default function SearchBox({TitleButton,link}:any) {
    return (
        <div className="search   py-5 flex flex-wrap gap-y-5 items-center justify-between">
            ...
            <a href={link} className='w-full'>
                <button className="bg-gradient-to-r from-[#424242] to-[#1E1E1E]  w-full h-[44px]  font-medium text-[20px] leading-6 border hover:shadow-2xl  border-[#1E1E1E] text-white   rounded py-2 px-7 md:px-14 ">
                    {TitleButton}
