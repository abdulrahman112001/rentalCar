...
export default function ArticleBox({ArticleImage,ArticleTitle,ArticleContent,date}:any) {
    return (
        <div className="group article-box w-full sm:w-[47%] lg:w-[31%] shadow-lg rounded-xl ">
            ...
            <div className="content w-full p-6 bg-[#FAF9F9] group-hover:bg-[#EFECEC] rounded-b-xl">
                ...
                <div>
                <p className='text-[18px] leading-6 mb-5 font-normal'>
                {ArticleContent}
                <a href='' className='text-[#3ea62b]'>Read More</a>
                </p>
                </div>
