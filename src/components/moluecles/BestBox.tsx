    ...
    return (
        <div className="group best-box w-full sm:w-[47%] lg:w-[32%] shadow-lg rounded-t-lg">
            ...
            <Swiper
                ...
                className="mySwiper"
            >
                <SwiperSlide><Image src={Image1} alt='' className='w-full rounded-t-lg'/></SwiperSlide>
                <SwiperSlide><Image src={Image2} alt='' className='w-full rounded-t-lg'/></SwiperSlide>
                <SwiperSlide><Image src={Image3} alt='' className='w-full rounded-t-lg'/></SwiperSlide>
            ...
            <div className="content w-full p-6 bg-[#f3efef71] group-hover:bg-[#EFECEC]">
                ...
                <div className='mt-6 relative'>
                    ...
                    <a href="" className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 hidden group-hover:block' ><Image src={SeeDetails} alt='' /></a>
