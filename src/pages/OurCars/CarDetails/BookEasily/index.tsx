...
export default function index() {
    return (
        <div className="container mx-auto my-12 relative px-5">
            <a href="">
                <span className="absolute text-[22px] font-medium text-[#D5281D] -top-[0px]  left-[10px]">Cancel</span>
            </a>
            <h2 className="text-[24px] font-medium leading-[30px] text-center mb-12">
                BookEasily
            </h2>
            <div className="book lg:w-[560px] mx-auto ">
                <div className='rounded-lg p-2 bg-[#FAF9F9] flex gap-3 mb-8 shadow-lg'>
                    <Image src={Check1} alt='' className='w-[160px] min-h-[124px]'/>
                ...
                <div className='mb-8'>
                    ...
                    <div className='bg-[#FAF9F9] p-5 shadow-lg'>
